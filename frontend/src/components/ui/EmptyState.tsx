  ...
  return (
    <div className="text-center py-12 sm:py-16 px-4 border border-dashed border-gray-300 rounded-2xl bg-gray-50/50">
      ...
      {accion && (
        <Link
          href={accion.href}
          className="inline-flex items-center px-5 py-2.5 bg-black text-white text-sm font-medium rounded-full hover:bg-orange-500 hover:text-white hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-200"
        >
          {accion.label}
        </Link>
      )}
