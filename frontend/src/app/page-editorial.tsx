...
const CATEGORIAS_PRINCIPALES = [
  { id: 'empleo', label: 'Empleo', href: '/empleo', desc: 'Encuentra trabajo cerca de ti' },
  { id: 'formacion', label: 'Formación', href: '/formacion', desc: 'Cursos y becas disponibles' },
  { id: 'vivienda', label: 'Vivienda', href: '/vivienda', desc: 'Alquiler y habitaciones' },
  { id: 'ocio', label: 'Ocio y Cultura', href: '/ocio', desc: 'Eventos y actividades' },
  { id: 'ayudas', label: 'Ayudas y Becas', href: '/servicios', desc: 'Recursos económicos' },
  { id: 'voluntariado', label: 'Voluntariado', href: '/servicios', desc: 'Participa y colabora' },
];
...
const AYUDAS_CITYPAJ = [
  { title: 'Encontrar empleo', desc: 'Ofertas laborales en tu provincia', category: 'empleo' },
  { title: 'Acceder a formación', desc: 'Cursos gratuitos y becas', category: 'formacion' },
  { title: 'Buscar vivienda', desc: 'Alquiler asequible y habitaciones', category: 'vivienda' },
  { title: 'Descubrir cultura', desc: 'Eventos y actividades locales', category: 'ocio' },
  { title: 'Conocer ayudas', desc: 'Subvenciones y apoyos económicos', category: 'ayudas' },
  { title: 'Participar', desc: 'Unirte a la comunidad local', category: 'comunidad' },
  { title: 'Enviar propuestas', desc: 'Mejorar tu provincia', category: 'propuestas' },
  { title: 'Encontrar recursos', desc: 'Servicios públicos y privados', category: 'recursos' },
];
...
function HomePageContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Editorial - Inspirado en majordomedigital.fr */}
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20 lg:py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="font-sans text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
      ...
      {/* CityPAJ te ayuda a... - Bloque de valor */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="font-sans text-xl text-gray-600 max-w-3xl mx-auto">
              Todo lo que necesitas para crecer, participar y conectar en tu provincia
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {AYUDAS_CITYPAJ.map((ayuda, index) => (
              <div key={index} className="group">
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 h-full hover:border-blue-500 hover:shadow-lg transition-all duration-300">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                    <span className="text-blue-600 font-bold text-lg">{index + 1}</span>
                  </div>
                  <h3 className="font-serif text-xl font-bold text-black mb-3 group-hover:text-blue-600 transition-colors text-center">
                    {ayuda.title}
                  </h3>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="font-sans text-gray-600 max-w-2xl mx-auto">
                Sé el primero en publicar una oportunidad en tu provincia
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-serif text-lg font-bold text-black">Envía tus necesidades</h4>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-serif text-lg font-bold text-black">Participa en debates</h4>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-serif text-lg font-bold text-black">Propone mejoras</h4>
      ...
      {/* Bloque Institucional - Confianza */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-black mb-6">
