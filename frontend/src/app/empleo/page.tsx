    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="w-[80%] max-w-6xl mx-auto px-6 py-14">
        <div className="border-b border-black pb-6">
          <h1 className="font-serif text-3xl sm:text-4xl font-bold text-black">Empleo en {comunidadAutonoma || 'España'}</h1>
          <p className="mt-2 font-sans text-sm text-[#666666]">Ofertas de empleo, prácticas y voluntariado.</p>
        </div>

        <FiltroAvanzado 
          onFiltroChange={handleFiltroChange}
          categoriaInicial="empleo"
        />
