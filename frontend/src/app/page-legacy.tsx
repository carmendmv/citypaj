...
import ProductionLanguageSelector from '@/components/ui/ProductionLanguageSelector';
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-20 right-4 z-50 bg-white border border-gray-300 rounded-lg p-2 shadow-lg">
        <ProductionLanguageSelector variant="compact" showNames={false} />
      </div>
