...
console.log('🚀 Iniciando servidor working de CityPaj');
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`🚀 Servidor working corriendo en http://0.0.0.0:${PORT}`);
  console.log(`📊 Health check: http://0.0.0.0:${PORT}/health`);
  console.log('✅ Servidor working listo para recibir peticiones');
});
